...
def build_classifier(embedding_layer_type: str, num_classes: int,):    
    if embedding_layer_type == "cnn":
        return CNN1DClassifier(
            input_dim= 320,
            num_classes= num_classes,
        )
    
    if embedding_layer_type == "gru":
    ...
    raise ValueError(f"Unsupported embedding layer type: {embedding_layer_type}")
...
def main():
    ...
    embedding_layer_type = config["embedding_layer_type"]
